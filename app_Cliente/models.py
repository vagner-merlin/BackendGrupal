...
class Documentacion(models.Model):
    ...
    documento_url = models.URLField(max_length=200 , null=True, blank=True)
    fecha_registro = models.DateField(auto_now_add=True)
...
class Trabajo(models.Model):
    ...
    extracto_url = models.URLField(max_length=200 , null=True, blank=True)
...
class Domicilio(models.Model):
    ...
    croquis_url = models.URLField(max_length=200 , null=True, blank=True)
